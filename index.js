...
//       const ageInHours =
//         (now - new Date(idea.createdAt).getTime()) / (1000 * 60 * 60);
//       const recencyBonus = Math.max(0, 100 - ageInHours);
//       const score = idea.views * 1 + idea.likes * 3 + recencyBonus;
...
//   try {
//     const comments = await Comment.find({ userEmail: req.params.email }).sort({
//       createdAt: -1,
//     });
//     res.json(comments);
//   } catch (error) {
